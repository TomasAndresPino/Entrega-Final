...
grouped = df.groupby('Failure_Mode')['Duration'].mean().reset_index()
...
bars = plt.bar(grouped_sorted['Failure_Mode'], grouped_sorted['Duration'], color=colors_sorted)

# Añade etiquetas y título
plt.xlabel('Machine ID')
plt.ylabel('Duración Promedio (horas)')
plt.title('Duración Promedio de Mantenimiento por Tipo de Falla')
