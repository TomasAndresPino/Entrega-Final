...
def cargar_hazzard(nombre_archivo: str) -> Generator:
    nombre = nombre_archivo + ".csv"
    with open(f"/home/mabbottb/A/Capstone/Entrega-Final/E2/BasesCox/{nombre}", "r", encoding= "latin-1") as archivo:
        yield from generador_hazard(archivo)
...
def cargar_probabilidades(nombre_archivo: str) -> Generator:
    nombre = nombre_archivo + ".csv"
    with open(f"/home/mabbottb/A/Capstone/Entrega-Final/E2/KMs/{nombre}", "r", encoding= "latin-1") as archivo:
